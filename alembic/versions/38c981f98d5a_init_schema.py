...
Revision ID: 38c981f98d5a
Revises: 
Create Date: 2025-06-19 09:41:12.075712
...
def upgrade() -> None:
    ...
    sa.Column('num_control', sa.String(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id_grupo', 'id_alumno')
    )
